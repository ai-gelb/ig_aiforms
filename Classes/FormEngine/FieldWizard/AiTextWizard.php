...
class AiTextWizard extends AbstractNode
{
    public function render(): array
    {
        ...
        $resultData['html'] = '<div class="form-control"><button class="btn btn-default igjs-form-text-ai" data-what-do-you-want="' . $fieldWizardConfig['aiWhatDoYouWant'] . '" data-ai-to-read="' . $fieldWizardConfig['aiToRead'] . '"  data-ai-to-paste="data' . $this->data['elementBaseName'] . '" type="button">' . $buttonTitle . ' ' . $icon . '</button></div>';
